...
def test_model_forward_esfe():
    """Test build and tensor inference path for the custom YOLOv8 ESFE model."""
    model = YOLO("ultralytics/cfg/models/v8/yolov8-esfe.yaml")
    results = model(torch.zeros(1, 3, 64, 64), imgsz=64)
